...
class Client(metaclass=ClientVerifier):
    ...
    def __init__(self,serv_addr=server_address, serv_port=server_port,action=PRESENCE, mode='f', acc='Guest'):
    ...
    @logger
    def create_presence_meassage(self,account_name, Action=PRESENCE):
    ...
    def start_client(self):
        ...
        with socket(AF_INET,SOCK_STREAM) as s:
            ...
            message = self.create_presence_meassage(self.account,self.action)
